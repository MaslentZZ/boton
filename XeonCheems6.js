...
case 'chatbapakdisurga':
    m.reply('Koneksi tidak stabil Karena melawan kodrat tuhan');
    break;
...
let buttonMessage = {
image: {url: `https://i.ibb.co/SNgPmLG/donasi.jpg`},
jpegThumbnail: log0,
caption: teks,
footer: `${botname}`,
buttons: buttons,
...
mediaType:1,
mediaUrl: 'https://i.ibb.co/SNgPmLG/donasi.jpg',
sourceUrl: "https://i.ibb.co/SNgPmLG/donasi.jpg"
}}
}
XeonBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
}
...
`
            ...
            let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: 'All Menu' }, type: 1 },{ buttonId: 'command', buttonText: { displayText: 'List Menu' }, type: 1 },{ buttonId: 'ai', buttonText: { displayText: 'OpenAi ChatGPT' }, type: 1 }]
            let buttonMessage = {
